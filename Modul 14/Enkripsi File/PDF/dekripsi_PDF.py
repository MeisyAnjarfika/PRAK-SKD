...
file = PdfFileReader("D:/UNS/UNS MADIUN/Sistem Keamanan Data/Materi_Praktikum/RSA/myfile_encrypted.pdf")
...
if file.isEncrypted:
    ...
    with open("D:/UNS/UNS MADIUN/Sistem Keamanan Data/Materi_Praktikum/RSA/myfile_decrypted.pdf", "wb") as f:
